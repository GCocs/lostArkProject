...
CREATE TABLE RECOMMEND_COLLECTIBLE (
    RECOMMEND_COLLECTIBLE_NUMBER INT AUTO_INCREMENT PRIMARY KEY,
    RECOMMEND_COLLECTIBLE_NAME VARCHAR(50) NOT NULL,
    RECOMMEND_COLLECTIBLE_LINK VARCHAR(255) NOT NULL
)
...
CREATE TABLE MEMBER (
    ...
    RECOMMEND_COLLECTIBLE_NUMBER INT,
    FOREIGN KEY (RECOMMEND_COLLECTIBLE_NUMBER) REFERENCES RECOMMEND_COLLECTIBLE(RECOMMEND_COLLECTIBLE_NUMBER)
);
