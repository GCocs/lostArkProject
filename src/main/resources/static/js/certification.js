    ...
    if(data) {
        ...
        const imgDom = `
            <div class="position-relative image-wrapper">
                ...
                <img class="position-absolute" src="${equipment['귀걸이'].icon}" style="width:36px; left:calc(50% + 30%); transform:translate(-50%, -50%); top:calc(2 / 8 * 100%); border-radius:3px; opacity:${equipment['귀걸이'].unequippedRequired == true ? '0.3' : '1' }; background-color:${selectBackground(equipment['귀걸이'].grade)}" />
                ...
                <img class="position-absolute" src="${equipment['반지'].icon}" style="width:36px; left:calc(50% + 30%); transform:translate(-50%, -50%); top:calc(4 / 8 * 100%); border-radius:3px; opacity:${equipment['반지'].unequippedRequired == true ? '0.3' : '1' }; background-color:${selectBackground(equipment['반지'].grade)}" />
